...
// #define SURVEY_ACC 60000 // svinAccLimit, đơn vị 0.1mm (4000 = 40cm)
...
// float currentAccM = 0.0f; // survey-in accuracy in meters (0.1mm units → /10000)
// uint32_t currentDur = 0;  // survey-in duration in seconds

// // ---------- OLED ----------

// // ---------- OLED Style D ----------
// // Header 2 dòng đảo màu (nền trắng, chữ đen), nội dung trắng trên nền đen
...
//     // UBX-NAV-SVIN
//     if (cls == 0x01 && id == 0x3B && payloadLen >= 28)
//     {
...
//                 sendUBX(0x06, 0x71, nullptr, 0); // ping
//             }
//         }
...
//     else
//     {
//         // Splash screen: hiển thị icon căn giữa 2 giây
//         oled.clearDisplay();
//         oled.drawBitmap(
//             (OLED_WIDTH - LOGO_W) / 2,
